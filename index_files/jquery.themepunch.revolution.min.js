	...
	jQuery.fn.extend({
		...
		********************************/
		...
		function swapSlideProgress(container,opt) {
			...
			var transitionsArray = [ ['boxslide' , 0, 1],
									 ['boxfade', 1, 0],
									 ['slotslide-horizontal', 2, 0],
									 ['slotslide-vertical', 3, 0],
									 ['curtain-1', 4, 0],
									 ['curtain-2', 5, 0],
									 ['curtain-3', 6, 0],
									 ['slotzoom-horizontal', 7, 0],
									 ['slotzoom-vertical', 8, 0],
									 ['slotfade-horizontal', 9, 0],
									 ['slotfade-vertical', 10, 0],
									 ['fade', 11, 0],
									 ['slideleft', 12, 0],
									 ['slideup', 13, 0],
									 ['slidedown', 14, 0],
									 ['slideright', 15, 0],
									 ['papercut', 16, 0],
									 ['3dcurtain-horizontal', 17, 0],
									 ['3dcurtain-vertical', 18, 0],
									 ['cubic', 19, 0],
									 ['cube',19,0],									 
									 ['flyin', 20, 0],
									 ['turnoff', 21, 0],
									 ['incube', 22, 0],
									 ['cubic-horizontal', 23, 0],									 									 									 									 									 									 									 									 									 									 									 									 									 									 									 									 									 									 									 									 									 
									 ['cube-horizontal', 23, 0],									 
									 ['incube-horizontal', 24, 0],									 									 									 									 									 									 									 									 									 									 									 									 									 									 									 									 									 									 									 									 									 
									 ['turnoff-vertical', 25, 0]
									 ['fadefromright', 12, 1],
									 ['fadefromleft', 15, 1],
									 ['fadefromtop', 14, 1],
									 ['fadefrombottom', 13, 1],
									 ['fadetoleftfadefromright', 12, 2],
									 ['fadetorightfadetoleft', 15, 2],
									 ['fadetobottomfadefromtop', 14, 2],
									 ['fadetotopfadefrombottom', 13, 2],
									 ['parallaxtoright', 12, 3],
									 ['parallaxtoleft', 15, 3],
									 ['parallaxtotop', 14, 3],
									 ['parallaxtobottom', 13, 3],	
									 ['scaledownfromright', 12, 4],
									 ['scaledownfromleft', 15, 4],
									 ['scaledownfromtop', 14, 4],
									 ['scaledownfrombottom', 13, 4],	
									 ['zoomout', 13, 5],
									 ['zoomin', 13, 6]]
			...
			nexttrans=Math.round(Math.random()*25);
				nextli.data('slotamount',Math.round(Math.random()*12+4));
				specials = Math.round(Math.random()*5);
				if (specials>6) specials=6;
			
			transitionsArray.forEach(function(trans) {
				if (trans[0] == comingtransition) {
					nexttrans = trans[1];
					specials = trans[2];
				}
			})							
			...
			if (comingtransition=="random-premium")   {
						nexttrans=Math.round(Math.random()*9+16);
			...
			if (nexttrans==0) {								// BOXSLIDE
						...
						nextsh.find('.slotslide').each(function(j) {
							...
							TweenLite.fromTo(ss,(masterspeed)/600,
												...
												{opacity:1,transformPerspective:500,top:0,left:0,scale:1,rotation:0,delay:((j)*15 + (curz)*30)/1500, ease:Power2.easeOut,onComplete:function() {
			...
			if (nexttrans==1) {
						...
						nextsh.find('.slotslide').each(function(j) {
							...
							TweenLite.fromTo(ss,rand/1000,
										{opacity:0,transformPerspective:500,rotation:opt.rotate},
						...
						nextsh.find('.slotslide').each(function() {
							var ss=jQuery(this);
								...
								TweenLite.fromTo(ss,masterspeed/1000,
												{left:0-opt.slotw, rotation:opt.rotate,transformPerspective:500},
			...
			if (nexttrans==3) {
						...
						actsh.find('.slotslide').each(function() {
							var ss=jQuery(this);
									TweenLite.to(ss,masterspeed/1000,{top:opt.sloth,rotation:opt.rotate,transformPerspective:500,onComplete:function() {
															removeSlots(container,opt);
															nextsh.find('.defaultimg').css({'opacity':1});
															if (nextli.index()!=actli.index()) actsh.find('.defaultimg').css({'opacity':0});
															opt.act=opt.next;
						...
						nextsh.find('.slotslide').each(function() {
							var ss=jQuery(this);
								...
								TweenLite.fromTo(ss,masterspeed/1000,
												{top:0-opt.sloth,rotation:opt.rotate,transformPerspective:500},
			...
			if (nexttrans==4) {
						...
						actsh.find('.slotslide').each(function(i) {
							var ss=jQuery(this);
							TweenLite.to(ss,(masterspeed+(i*(70-opt.slots)))/1000,{transformPerspective:500,top:0+opt.height,opacity:1,rotation:opt.rotate,ease:Power2.easeOut});
						});

						// ALL NEW SLOTS SHOULD BE SLIDED FROM THE LEFT TO THE RIGHT
						nextsh.find('.slotslide').each(function(i) {
							var ss=jQuery(this);
									TweenLite.fromTo(ss,(masterspeed+(i*(60-opt.slots)))/1000,
													{top:(0-opt.height),opacity:0,rotation:opt.rotate,transformPerspective:500},
													{top:0,opacity:1,rotation:0,ease:Power2.easeOut,onComplete:function() {
															if (i==opt.slots-1) {
																removeSlots(container,opt);
																nextsh.find('.defaultimg').css({'opacity':1});
																if (nextli.index()!=actli.index()) actsh.find('.defaultimg').css({'opacity':0});
			...
			if (nexttrans==5) {
						...
						actsh.find('.slotslide').each(function(i) {
							var ss=jQuery(this);
									TweenLite.to(ss,(masterspeed+((opt.slots-i)*(70-opt.slots)))/1000,{top:0+opt.height,opacity:1,rotation:opt.rotate,transformPerspective:500,ease:Power3.easeOut});
						});

						// ALL NEW SLOTS SHOULD BE SLIDED FROM THE LEFT TO THE RIGHT
						nextsh.find('.slotslide').each(function(i) {
							var ss=jQuery(this);
									TweenLite.fromTo(ss,(masterspeed+((opt.slots-i)*(60-opt.slots)))/1000,
													{top:(0-opt.height),opacity:0,rotation:opt.rotate,transformPerspective:500},
													{top:0,opacity:1,rotation:0,ease:Power3.easeOut,onComplete:function() {
															if (i==0) {
																removeSlots(container,opt);
																nextsh.find('.defaultimg').css({'opacity':1});
																if (nextli.index()!=actli.index()) actsh.find('.defaultimg').css({'opacity':0});
			...
			if (nexttrans==6) {
						...
						actsh.find('.slotslide').each(function(i) {
							...
							TweenLite.to(ss,(masterspeed+tempo)/1000,{top:0+opt.height,opacity:1,rotation:opt.rotate,transformPerspective:500,ease:Power2.easeInOut});
							...
							if (i<opt.slots/2)
								...
								var tempo = (2+opt.slots-i)*60;
									...
									TweenLite.fromTo(ss,(masterspeed+tempo)/1000,
													{top:(0-opt.height),opacity:1,rotation:opt.rotate,transformPerspective:500},
			...
			if (nexttrans==9 || nexttrans==10) {
						...
						if (masterspeed<500) masterspeed=500;
						nextli.css({'opacity':1});
						...
						nextsh.find('.slotslide').each(function(i) {
							var ss=jQuery(this);
							ssamount++;
							TweenLite.fromTo(ss,masterspeed/1000,{opacity:0,transformPerspective:500,left:0,top:0},{opacity:1,ease:Power2.easeInOut,delay:(i*4)/1000});
			...
			if (nexttrans==16) {						// PAPERCUT
					...
					TweenLite.fromTo(actli.find('.tp-half-one'),masterspeed/1000,
					                 {width:oow,height:ooh/2,overflow:'hidden',position:'absolute',top:'0px',left:'0px',transformPerspective:500,transformOrigin:"center top"},
					                 {scale:sc1,rotation:ro1,y:(0-ooh-ooh/4),ease:Power2.easeInOut});

					TweenLite.fromTo(actli.find('.tp-half-one'),masterspeed/2000,{opacity:1,transformPerspective:500,transformOrigin:"center center"},{opacity:0,delay:masterspeed/2000});

					TweenLite.fromTo(actli.find('.tp-half-two'),masterspeed/1000,
					                 {width:oow,height:ooh,overflow:'hidden',position:'absolute',top:ooh/2,left:'0px',transformPerspective:500,transformOrigin:"center bottom"},
					                 {scale:sc2,rotation:ro2,y:ooh+ooh/4,ease:Power2.easeInOut});

					TweenLite.fromTo(actli.find('.tp-half-two'),masterspeed/2000,{opacity:1,transformPerspective:500,transformOrigin:"center center"},{opacity:0,delay:masterspeed/2000});

					if (actli.html()!=null)
						TweenLite.fromTo(nextli,(masterspeed-200)/1000,{opacity:0,scale:0.8,x:opt.width*xof, y:ooh*yof,rotation:ro3,transformPerspective:500,transformOrigin:"center center"},{rotation:0,scale:1,x:0,y:0,opacity:1,ease:Power2.easeInOut});
			...
			if (nexttrans==17) {								// 3D CURTAIN HORIZONTAL
						...
						nextsh.find('.slotslide').each(function(j) {
							...
							TweenLite.fromTo(ss,(masterspeed)/800,
											{opacity:0,rotationY:0,scale:0.9,rotationX:-110,transformPerspective:500,transformOrigin:"center center"},
			...
			if (nexttrans==18) {								// 3D CURTAIN VERTICAL
						...
						nextsh.find('.slotslide').each(function(j) {
							...
							TweenLite.fromTo(ss,(masterspeed)/500,
											{opacity:0,rotationY:310,scale:0.9,rotationX:10,transformPerspective:500,transformOrigin:"center center"},
											{opacity:1,top:0,left:0,scale:1,rotation:0,rotationX:0,rotationY:0,ease:Power3.easeOut,delay:j*0.06,onComplete:function() {
													if (j==opt.slots-1) {
														removeSlots(container,opt);
														nextsh.find('.defaultimg').css({'opacity':1});
			...
			if (nexttrans==20 ) {								// FLYIN
						...
						nextsh.find('.slotslide').each(function(j) {
							...
							TweenLite.fromTo(ss,masterspeed/1500,
											{left:ofx,rotationX:40,z:-600, opacity:op,top:0,transformPerspective:1600,transformOrigin:torig,rotationY:rot},
											{left:0, delay:(j*50)/1000,ease:Power2.easeInOut});

							TweenLite.fromTo(ss,masterspeed/1000,
											{rotationX:40,z:-600, opacity:op,top:0,scale:1,transformPerspective:1600,transformOrigin:torig,rotationY:rot},
						...
						actsh.find('.slotslide').each(function(j) {
							...
							TweenLite.fromTo(ss,masterspeed/1000,
											{opacity:1,rotationX:0,top:0,z:0,scale:1,left:0, transformPerspective:1600,transformOrigin:torig, rotationY:0},
			...
			if (nexttrans==21 || nexttrans==25) {								// TURNOFF
					masterspeed = masterspeed+1600;
						...
						nextsh.find('.slotslide').each(function(j) {
							...
							TweenLite.fromTo(ss,masterspeed/1500,
											{left:0,rotationX:rot2,z:0, opacity:0,top:0,scale:1,transformPerspective:1600,transformOrigin:torig,rotationY:rot},
						...
						actsh.find('.slotslide').each(function(j) {
							...
							TweenLite.fromTo(ss,masterspeed/3000,
											{left:0,rotationX:0,z:0, opacity:1,top:0,scale:1,transformPerspective:1600,transformOrigin:torig,rotationY:0},
			...
			if (nexttrans==23 || nexttrans == 24) {								// cube-horizontal - inboxhorizontal
						...
						nextsh.find('.slotslide').each(function(j) {
							...
							TweenLite.fromTo(ss,masterspeed/1000,
											{left:opx,rotationX:opt.rotate,opacity:op,top:0,scale:1,transformPerspective:1600,transformOrigin:torig,rotationY:rot},
						...
						actsh.find('.slotslide').each(function(j) {
							var ss=jQuery(this);
							TweenLite.fromTo(ss,masterspeed/1000,
											{left:0,opacity:1,rotationX:0,top:0,z:0,scale:1,transformPerspective:1600,transformOrigin:torig, rotationY:0},
															...
															nextcaption.hasClass('skewtoleftshort'))
														{
															...
															nextcaption.data('outanim',TweenLite.to(nextcaption,mspeed,
																		{ left:xx,
																		  ...
																		  onComplete:function() {
																			   nextcaption.css({visibility:'hidden'});
																		  }
																		 }));
...
/********************************************
	-	THEMEPUNCH TOOLS Ver. 1.0     -
	 Last Update of Tools 20.08.2013
*********************************************/
